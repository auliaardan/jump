...
from .models import seminars_page, about_us, workshops_page, PaymentProof, Seminar, SciComSubmission, SymposiumFaculty


@receiver(post_delete, sender=seminars_page)
def delete_media_files_seminars(sender, instance, **kwargs):
    image_fields = [
        instance.flyer_image,
        instance.at_a_glance_image,
        instance.venue_image,
    ]
...
@receiver(post_delete, sender=SymposiumFaculty)
def delete_media_files_symposium_faculty(sender, instance, **kwargs):
    if instance.image:
